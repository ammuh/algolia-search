...
for url in urls:
    a_name = url.split("/")[-1].split(".")[0]
    download = "https://www.w3.org/services/html2txt?url={}&noinlinerefs=on".format(urllib.parse.quote(url, safe=''))
   
    urllib.request.urlretrieve(download, a_name + ".txt")